...
S.Page {
    ...
    S.SilicaFlickable {
        ...
        Column {
            ...
            GalleryLabel {
                text: qsTr("The Opal.Delegates module supports drag and drop " +
            ...
            GalleryLabel {
                text: qsTr("It only takes a few lines more code to enable drag and drop" +
            ...
            GalleryLabel {
                text: qsTr("In long lists, dragging below the bottom end or above " +
